 ...
 *
 * Kotlin/Wasm's JS interop for this simple `js("...")`-bodied top-level function pattern mirrors
 * Kotlin/JS exactly, but this sandbox has no network access to actually run a wasmJs browser
 * build, so this is unverified by a real compile — if the first web build surfaces a syntax
 * issue here, it's isolated to this one file.
 */
